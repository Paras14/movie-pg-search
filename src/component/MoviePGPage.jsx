  ...
  return (
    <div>
      ...
      <div className='lg:px-20 md:px-16 sm:px-8 px-2'>
        <div className="flex sm:flex-row md:flex-row lg:flex-row flex-col items-start my-5 mx-14 text-4xl font-extrabold gap-10 bg-pgMovieCardBg p-2 rounded-sm">
          ...
          <div className="flex-auto flex flex-col mt-8 mx-auto">
        ...
        <div className='m-2 p-5 flex flex-col gap-8'>
          <p className="font-normal bg-categBg p-5 rounded"><span className='font-bold text-lg'>Advisory Alcohol:</span> <ul className='list-none flex flex-col gap-2'>{movieData["data"]["advisoryAlcohol"].length>0?movieData["data"]["advisoryViolence"].map(item => <li className='bg-categItemBg p-1 rounded-sm'>{item}</li>):"Sorry, but there is no information available on this category right now"}</ul></p>
          <p className="font-normal bg-categBg p-5 rounded"><span className='font-bold text-lg'>Advisory Frightening:</span> <ul className='list-none flex flex-col gap-2'>{movieData["data"]["advisoryFrightening"].length>0?movieData["data"]["advisoryViolence"].map(item => <li className='bg-categItemBg p-1 rounded-sm'>{item}</li>):"Sorry, but there is no information available on this category right now"}</ul></p>
          <p className="font-normal bg-categBg p-5 rounded"><span className='font-bold text-lg'>Advisory Nudity:</span> <ul className='list-none flex flex-col gap-2'>{movieData["data"]["advisoryNudity"].length>0?movieData["data"]["advisoryViolence"].map(item => <li className='bg-categItemBg p-1 rounded-sm'>{item}</li>):"Sorry, but there is no information available on this category right now"}</ul></p>
          <p className="font-normal bg-categBg p-5 rounded"><span className='font-bold text-lg'>Advisory Profanity:</span> <ul className='list-none flex flex-col gap-2'>{movieData["data"]["advisoryProfanity"].length>0?movieData["data"]["advisoryViolence"].map(item => <li className='bg-categItemBg p-1 rounded-sm'>{item}</li>):"Sorry, but there is no information available on this category right now"}</ul></p>
          <p className="font-normal bg-categBg p-5 rounded"><span className='font-bold text-lg'>Advisory Violence:</span> <ul className='list-none flex flex-col gap-2'>{movieData["data"]["advisoryViolence"].length>0?movieData["data"]["advisoryViolence"].map(item => <li className='bg-categItemBg p-1 rounded-sm'>{item}</li>):"Sorry, but there is no information available on this category right now"}</ul></p>
        </div>
