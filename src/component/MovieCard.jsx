...
function MovieCard(props) {
  ...
  return (
    ...
    aspect-video border-2 cursor-pointer hover:scale-105 transition duration-600 flex flex-col justify-between mx-auto rounded-sm font-firaSans' onClick={props.cardHandle}>
        <div className="h-72 w-full bg-slate-700 border-1 mb-px border-gray-950" style={cardComponentStyle}></div>
        <div className="h-20 w-full bg-slate-200 border-1 flex flex-col justify-between border-gray-950 p-2 rounded-sm">
